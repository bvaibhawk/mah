    ...
    with col26:
        pavilioninc = st.selectbox("PAVILION_INCLUSION_needless",
                                   options=['0', 'PP1', 'PP2', 'F1', 'F2', 'F3', 'F4', 'TW1', 'TW2', 'TW3', 'N1', 'N2',
                                            ...
                                            'None'])
    with col27:
        tableopen = st.selectbox("TABLE_OPEN",
                                 options=['No', 'EX-Open-HO-Table', 'EX-Open-Small-Table', 'EX-Open-Medium-Table',
                                          'EX-Open-Big-Table', 'VG-Open-HO-Table', 'VG-Open-Small-Table',
                                          'VG-Open-Medium-Table', 'VG-Open-Big-Table', 'G-Open-HO-Table',
                                          'G-Open-Small-Table', 'G-Open-Medium-Table', 'G-Open-Big-Table'])
    with col28:
        topnatural = st.selectbox("TOP_NATURAL",
                                  options=['No', 'EX-Natural-Indented Natural-Top', 'EX-Natural-Natural-Top',
                                           'EX-Natural-Big Natural-Top', 'VG-Natural-Indented Natural-Top',
                                           'VG-Natural-Natural-Top', '', '', '', ''])
    with col29:
