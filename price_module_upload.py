    ...
    if price_module_file:
        ...
        if start_conversion:
            try:
                ...
                total_files = glob.glob("miscellenious_discounts/input_files/pricing_module/*.xlsx")
                ...
                with open(os.path.join('miscellenious_discounts/input_files/pricing_module',
                                       f'/input_price_module_discounts_{final_datetime}.xlsx'), "wb") as f:
